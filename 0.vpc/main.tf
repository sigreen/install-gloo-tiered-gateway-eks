...
################################################################################
# Management cluster additional security group for cross cluster communication
################################################################################

resource "aws_security_group" "mgmtcluster_additional_sg" {
  name        = "mgmtcluster_additional_sg"
...
resource "aws_vpc_security_group_egress_rule" "mgmtcluster_additional_sg_allow_all_4" {
  security_group_id = aws_security_group.mgmtcluster_additional_sg.id

  ip_protocol = "-1"
  cidr_ipv4   = "0.0.0.0/0"
}
resource "aws_vpc_security_group_egress_rule" "mgmtcluster_additional_sg_allow_all_6" {
  security_group_id = aws_security_group.mgmtcluster_additional_sg.id
...
################################################################################
# cross SG  ingress rules management cluster allow to cluster 1 + 2
################################################################################

resource "aws_vpc_security_group_ingress_rule" "cluster1_to_mgmtcluster" {
  security_group_id = aws_security_group.mgmtcluster_additional_sg.id
...
resource "aws_vpc_security_group_ingress_rule" "cluster2_to_mgmtcluster" {
  security_group_id = aws_security_group.mgmtcluster_additional_sg.id
